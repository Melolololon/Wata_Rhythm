...
void MelLib::ADSAMaterial::Create(const DrawOption& drawData, const unsigned int textureNum)
{
	...
	ShaderDataSet set =
	{
		{ L"Shader/FbxVertexShader.hlsl","main","vs_5_0" },
		{ L"NULL","","" },
		{ L"NULL","","" },
		{ L"LIB","main","gs_5_0" },
		{ L"Shader/FbxPixelShader.hlsl","main","ps_5_0" }
	};
...
void MelLib::PBRMaterial::Create(const DrawOption& drawData, const unsigned int textureNum)
{
	...
	ShaderDataSet set =
	{
		...
		{ L"NULL","","" },
		{ L"NULL","","" },
		{ L"Shader/FbxGeometryShader.hlsl","main","gs_5_0" },
		{ L"Shader/PBRPixelShader.hlsl","main","ps_5_0" }
	};
